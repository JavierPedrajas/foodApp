  ...
  return (
    <div className={"terms"}>
      ...
      <p>
        ...
        uso del sitio web de RandoMenu, ubicado en www.randomenuapp.com.{" "}
      </p>{" "}
      <p>
        {" "}
        Al acceder a este sitio web, asumimos que aceptas estos términos y
        condiciones. No continúes usando RandoMenu si no estás de acuerdo con
      ...
      <p>
        ...
        en línea. Al acceder a RandoMenu, aceptaste utilizar las cookies
        necesarias.{" "}
      </p>{" "}
      <p>
        {" "}
      ...
      <ul>
        {" "}
        <li> Copiar o volver a publicar material de RandoMenu </li>{" "}
        <li> Vender, alquilar o sublicenciar material de RandoMenu </li>{" "}
        <li> Reproducir, duplicar o copiar material de RandoMenu </li>{" "}
        <li> Redistribuir contenido de RandoMenu </li>{" "}
      </ul>{" "}
      ...
      <p>
        {" "}
        RandoMenu se reserva el derecho de monitorear todos los comentarios y
      ...
      <p>
        ...
        publicaciones o a otra información del sitio siempre que el enlace: (a)
        no sea engañoso de ninguna manera; (b) no implique falsamente
        patrocinio, respaldo o aprobación de la parte vinculante y sus productos
        y/o servicios; y (c) encaja en el contexto del sitio de la parte
        vinculante.{" "}
      </p>{" "}
      <p>
        {" "}
      ...
      <p>
        {" "}
        Aprobaremos las solicitudes de enlace de estas organizaciones si: (a) el
        enlace no nos haría vernos desfavorablemente a nosotros mismos ni a
        nuestras empresas acreditadas; (b) la organización no tiene registros
        negativos con nosotros; (c) el beneficio para nosotros de la visibilidad
        del hipervínculo compensa la ausencia de RandoMenu; y (d) el enlace está
      ...
      <p>
        ...
        interesada en vincularte a nuestro sitio web, debes informarnos enviando
        un correo electrónico a RandoMenu. Incluye tu nombre, el nombre de tu
        organización, la información de contacto, así como la URL de tu sitio,
        una lista de las URL desde las que tienes la intención de vincular a
        nuestro sitio web y una lista de las URL de nuestro sitio a las que te
        gustaría acceder. Espera 2-3 semanas para recibir una respuesta.{" "}
      </p>{" "}
      <p>
        {" "}
        Las organizaciones aprobadas pueden hacer hipervínculos a nuestro sitio
      ...
      <p>
        {" "}
        No se permitirá el uso del logotipo de RandoMenu u otro material gráfico
      ...
      <p>
        ...
        sujetas al párrafo anterior; y (b) regirá todas las responsabilidades
